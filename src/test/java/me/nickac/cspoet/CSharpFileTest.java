...
public final class CSharpFileTest {
    ...
    @Ignore("This is the old java test")
    @Test
    public void importStaticReadmeExample() {
        ...
        CSharpFile example = CSharpFile.builder("com.example.helloworld", hello)
                .addStaticUsing(hoverboard, "createNimbus")
                .addStaticUsing(namedBoards, "*")
                .addStaticUsing(Collections.class, "*")
                .build();
        ...
        CSharpFile source = CSharpFile.builder("com.squareup.tacos",
                TypeSpec.classBuilder("Taco")
                        ...
                        .addMethod(MethodSpec.constructorBuilder()
                                ...
                                .build())
                        .build())
                .addStaticUsing(Thread.State.BLOCKED)
                .addStaticUsing(System.class, "*")
                .addStaticUsing(Thread.State.class, "valueOf")
                .build();
    ...
    @Ignore("addStaticUsing doesn't support members with $L")
    @Test
        ...
        CSharpFile source = CSharpFile.builder("com.squareup.tacos",
                TypeSpec.classBuilder("Taco")
                        .addMethod(MethodSpec.methodBuilder("main")
                                ...
                                .build())
                        .build())
                .addStaticUsing(System.class, "out")
                .build();
        assertThat(source.toString()).isEqualTo(""
                + "package com.squareup.tacos;\n"
                + "\n"
    ...
    public void importStaticOnce() {
        assertThat(CSharpFile.builder("readme", importStaticTypeSpec("Util"))
                .addStaticUsing(TimeUnit.SECONDS)
                .build().toString()).isEqualTo(""
                + "package readme;\n"
                + "\n"
    ...
    public void importStaticTwice() {
        assertThat(CSharpFile.builder("readme", importStaticTypeSpec("Util"))
                .addStaticUsing(TimeUnit.SECONDS)
                .addStaticUsing(TimeUnit.MINUTES)
                .build().toString()).isEqualTo(""
                + "package readme;\n"
                + "\n"
